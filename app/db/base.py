...
from app.models import user, material, chat, complaint, notification, content  # noqa: F401, E402

# Order is important => user must be imported before chat, complaint, notification due to foreign key dependencies
